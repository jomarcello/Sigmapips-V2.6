...
async def test_tradingview_calendar():
    """Test the TradingView calendar service with ScrapingAnt enabled."""
    # Enable ScrapingAnt with the API key
    os.environ["USE_SCRAPINGANT"] = "true"
    os.environ["SCRAPINGANT_API_KEY"] = "e63e7a6b8a9d4d0e8f1a2b3c4d5e6f30"  # This is the API key from the logs
    
    logger.info("Initializing TradingViewCalendarService with ScrapingAnt enabled")
